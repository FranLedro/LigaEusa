        ...
        <div class="container">
            ...
            <center>
                    ...
                    <div id="formulario">              
                        ...
                        <form class="formu" name="formu" method="post" action="">
                            ...
                            <p>
                                ...
                                <div class="col-xs-7-centered">
									<div class="col-xs-4">
										Number:<input type="text" class="form-control" name="numero" size="2" required>
									</div>
									<div class="col-xs-4">
										End date:<input type="date" 
										class="form-control"
										name="fecha_fin" min="<?php echo date("Y-m-d");?>" max="2016-12-31" value="<?php echo date("Y-m-d");?>">
									</div>
									...
									<div class="col-xs-7-centered">
										...
										<div>
											<input type="reset" name="Resetear" class="btn btn-danger"/>
										</div>
									</div>
								</div>								
